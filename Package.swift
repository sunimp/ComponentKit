...
let package = Package(
        ...
        dependencies: [
            ...
            .package(url: "https://github.com/sunimp/HUD.Swift.git", .upToNextMajor(from: "2.0.1")),
            .package(url: "https://github.com/sunimp/SectionsTableView.Swift.git", .upToNextMajor(from: "1.0.1")),
